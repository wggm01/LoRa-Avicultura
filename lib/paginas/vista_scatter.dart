...
import 'package:lora_avicultura/clases/cards_barplot.dart';



class VistaScatter extends StatelessWidget {
              ...
              return StreamBuilder(
                  ...
                  builder: (context, stream) {
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) => CardBarplot(stream.data.docs[index])
                    );
                  }
              );
            }
